...
namespace ProyectoPasteleria
{
    ...
    public partial class BaseDeDatosContainer : DbContext
    {
        public BaseDeDatosContainer()
            : base("name=BaseDeDatosContainer")
        {
        }
        ...
        public virtual DbSet<MediosEnvio> MediosEnvio { get; set; }
